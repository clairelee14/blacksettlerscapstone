<?php
/**
 * The template for displaying all "all things amber valley" single posts
 *
...
<main class="all-things-single-page">
    <div class="container">
        <a href="<?php echo get_permalink(get_page_by_title('Amber Valley')) ?>" class="back-arrow">Back To Amber
            Valley</a>
    </div>
    <div class="container">
            ...
            <div class="all-things-grid-container">
                <div class="content-container">
                    ...
                    <div class="copy-background">
                        <p>
                            <?php the_field('all_things_content_amber_valley'); ?>
                        </p>
                    </div>
                </div>
