<?php
/**
 * The template for displaying all "all things Edmonton" single posts
 *
...
<main class="all-things-single-page">
    <div class="container">
        <a href="<?php echo get_permalink(get_page_by_title('Edmonton')) ?>" class="back-arrow">Back To Edmonton</a>
    </div>
    <div class="container">
        <article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
            <div class="all-things-grid-container">
                <div class="content-container">
                    <h2>
                        <?php the_field('all_things_title_edmonton'); ?>
                    </h2>
                    <div class="all-things-image-container mobile">
                        <div
                            ...
                            <img src="<?php the_field('all_things_image_edmonton'); ?>">

                        </div>
                    </div>
                    <div class="copy-background">
                        <p>
                            <?php the_field('all_things_content_edmonton'); ?>
                        </p>
                    </div>
                </div>
